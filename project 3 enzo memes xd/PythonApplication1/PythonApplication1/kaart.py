...
def politiebureau():
    canvas.create_image(895, 305, image = pimg) #Doelwater (Hoofdbureau)
    canvas.create_image(900, 260, image = pimg) #Zaagmolenstraat
    canvas.create_image(925, 292, image = pimg) #Bureau Boezemsingel
    canvas.create_image(897, 230, image = pimg) #Noord
    canvas.create_image(960, 297, image = pimg) #Taborstraat
    canvas.create_image(926, 390, image = pimg) #Maashaven
    canvas.create_image(780, 345, image = pimg) #Marconiplein
    canvas.create_image(770, 260, image = pimg) #Overschie
    canvas.create_image(917, 440, image = pimg) #Zuidplein
    canvas.create_image(990, 410, image = pimg) #De Veranda
    canvas.create_image(950, 438, image = pimg) #Sandelingplein
    canvas.create_image(1058, 205, image = pimg) #J.J.P. Oudsingel
    canvas.create_image(655, 310, image = pimg) #Schiedam
    canvas.create_image(1138, 292, image = pimg) #Capelle a/d IJssel
