...
N = 10
criminaliteit2011 = (d.get_crime_data("average", "criminaliteit" ,"2011", "'Charlois'"),d.get_crime_data("average", "criminaliteit" ,"2011", "'Delfshaven'") , d.get_crime_data("average", "criminaliteit" ,"2011", "'Feijenoord'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Hillegersberg-Schiebroek'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Ijsselmonde'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Kralingen-Crooswijk'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Noord'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Overschie'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Prins-Alexander'"), d.get_crime_data("average", "criminaliteit" ,"2011", "'Centrum'"))
